...
nvidia-smi -l 1 -q -x -f /home/userName/br76_scratch/relion21_tutorial/pMOSP/nvidiaLogging-m3p-GNU-2.xml &
# Get its PID
nvidiaPID=$!
...
parallel -j2 --link MotionCor2_1.1.0-Cuda91 -InMrc /projects/m3home/userName/br76_scratch/relion21_tutorial/pMOSP/Micrographs/ -InSuffix {1} -OutMrc /projects/m3home/userName/br76_scratch/relion21_tutorial/pMOSP/JMotionCor/job-m3p-GNU-2/ -Patch 3 3 -Gpu {2} -Serial 1 -FmRef 1 -RotGain 0 -FlipGain 0 -Iter 7 -Tol 0.5 -Bft 150 -StackZ 0 -FtBin 1.0 -InitDose 0 -FmDose 1.0 -PixSize 0.97 -kV 300 -Throw 0 -Trunc 0 -Group 0 ::: 0_movie.mrcs 1_movie.mrcs ::: 0 1
